...
public class QComment extends EntityPathBase<Comment> {
    ...
    private static final long serialVersionUID = 1735767765L;
    ...
    public final com.bsc.stokoin.post.domain.QPost post;
    ...
    public QComment(Class<? extends Comment> type, PathMetadata metadata, PathInits inits) {
        ...
        this.post = inits.isInitialized("post") ? new com.bsc.stokoin.post.domain.QPost(forProperty("post"), inits.get("post")) : null;
